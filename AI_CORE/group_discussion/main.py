...
from group_discussion.agents.member_a_agent.agent import agent as member_a_agent
from group_discussion.agents.member_b_agent.agent import agent as member_b_agent
import logging
import random
...
async def ask(request: QueryRequest):
    try:
        ...
        session.state['turn'] = len(
            [m for m in conversation_history[request.user_id] if m["role"] == "user"])
